...
## Name:  ***Smart Cover*** 
### Description: 
**Samrt Cover** is the final project within the 'Introduction to Robotics' course. It is mainly designed for beginner driver to decrease the car accident rate. 
### Project details:
